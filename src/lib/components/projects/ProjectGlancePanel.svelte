...
<StickyPanel top="5rem">
  ...
  >
    ...
    {#if hasMetrics}
      <div class="mb-4">
        <CollapsibleSection title="Impact" open={true}>
    ...
    {#if project.stack.length > 0}
      <div class="mb-4">
        <CollapsibleSection title="Stack" open={true}>
    ...
    {#if hasServices}
      <div class="mb-4">
        <CollapsibleSection title="Services" open={true}>
    ...
    {#if hasLinks}
      <div class="mb-4">
        <CollapsibleSection title="Links" open={true}>
