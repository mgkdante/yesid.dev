...
<div
	bind:this={container}
	class="work-svg-icon flex items-center justify-center overflow-hidden rounded-lg border border-[var(--border-subtle)] bg-[var(--background)] transition-border-color duration-300"
