// Shells barrel export — Tier 3 composable page scaffolds.
// Built in Slice 17d-2.

export { default as SectionWrapper } from './SectionWrapper.svelte';
export { default as EdgeRail } from './EdgeRail.svelte';
export { default as AsidePanel } from './AsidePanel.svelte';
...
export type { AsidePanelProps } from './AsidePanel.svelte';
