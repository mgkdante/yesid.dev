...
>
	...
	<g id="train-stripe">
		...
		<rect x="22" y="53" width="458" height="3" fill="var(--accent)" opacity="0.55" />
		<!-- Primary orange stripe -->
		<rect x="22" y="56" width="458" height="10" fill="var(--primary)" />
	</g>
	...
	<g id="train-windows">
		...
		<rect x="430" y="40" width="34" height="23" rx="2" fill="var(--primary)" opacity="0.18" />
	</g>
	...
	<g id="train-lights">
		...
		<rect x="479" y="46" width="8" height="7" rx="2" fill="var(--accent)" />

		<!-- Lower headlight glow + rect -->
		<ellipse cx="488" cy="73" rx="14" ry="10" fill="url(#train-lg)" />
		<rect x="479" y="70" width="8" height="7" rx="2" fill="var(--primary)" />
	</g>
</svg>
