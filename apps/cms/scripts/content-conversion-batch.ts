		...
		values: {
			en: {
				...
				services_chrome_detail_cta_body:
					'Every build starts from your need, not a playbook. Bring the problem; the route gets drawn around it.',
				services_chrome_detail_cta_primary_label: 'Book a 20-min intro call →',
				services_chrome_detail_cta_secondary_label: 'or drop a line at /contact →',
				projects_chrome_detail_cta_overline: 'TERMINUS · THIS BUILD',
				projects_chrome_detail_cta_heading: 'Got a build like this in mind?',
				projects_chrome_detail_cta_body:
					'This one started as a need and an empty repo. Yours can start with a 20-minute call.',
				projects_chrome_detail_cta_primary_label: 'Book a 20-min intro call →',
				projects_chrome_detail_cta_secondary_label: 'or drop a line at /contact →',
			},
			fr: {
				...
				services_chrome_detail_cta_body:
					"Chaque projet part de ton besoin, pas d'un plan tout fait. Amène le problème; le trajet se dessine autour.",
				services_chrome_detail_cta_primary_label: 'Réserver un appel intro de 20 min →',
				services_chrome_detail_cta_secondary_label: 'ou écris-moi via /contact →',
				projects_chrome_detail_cta_overline: 'TERMINUS · CE PROJET',
				projects_chrome_detail_cta_heading: "T'as un projet du genre en tête?",
				projects_chrome_detail_cta_body:
					'Celui-ci a commencé par un besoin pis un dépôt vide. Le tien peut commencer par un appel de 20 minutes.',
				projects_chrome_detail_cta_primary_label: 'Réserver un appel intro de 20 min →',
				projects_chrome_detail_cta_secondary_label: 'ou écris-moi via /contact →',
			},
		},
	},
	{
