...
#   - dev DB schema + content = prod (including admin user = prod's mgkdante@gmail.com)
...
echo "prod's mgkdante@gmail.com):"
echo "  - Log in as mgkdante@gmail.com with prod password"
