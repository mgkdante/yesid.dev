...
export const techStackItems: readonly TechStackItem[] = [
	...
	},
	{
		enables: {
			...
			fr: 'remodèle les données de l\'entrepôt en modèles propres, testés et documentés',
		},
		icon: null,
		id: 'dbt',
		layer: 'logic',
	...
	},
	{
		enables: {
			...
			fr: 'fait rouler toute la boutique en ligne : produits, paiement et transactions dans une seule console d\'administration',
		},
		icon: null,
		id: 'shopify',
		layer: 'logic',
