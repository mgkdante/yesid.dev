...
const projects: readonly RawProject[] = [
	{
		...
		status: 'public',
		featured: true,
		repoUrl: 'https://github.com/yesid-dev/yesid.dev',
	...
	},
	{
		...
		repoUrl: 'https://github.com/yesid-dev/transit',
		readmeUrl: 'https://raw.githubusercontent.com/yesid-dev/transit/main/README.md',
		sections: [],
		impactMetric: {
			value: '30s',
