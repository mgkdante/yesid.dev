...
// → NO_FR 435, TOTAL 517.
const LOCKED = { TOTAL: 530, WITH_FR: 424, NO_FR: 106, ES_WITHOUT_FR: 0 } as const; // go2/about-real-person merged onto develop: develop's About shape + the FR superman pass (446-field drop) → high FR coverage
