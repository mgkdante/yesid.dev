...
const LOCKED = { TOTAL: 651, WITH_FR: 651, NO_FR: 0, ES_WITHOUT_FR: 0 } as const; // content-services: +14 fr leaves (new "Is this you?" ×4 + "When I'm not your guy" ×2 section title/content). Was 637 (slice-30 t1: +97 chrome leaves).
