...
// → NO_FR 435, TOTAL 517.
const LOCKED = { TOTAL: 530, WITH_FR: 530, NO_FR: 0, ES_WITHOUT_FR: 0 } as const; // slice-30: 100% FR coverage on walked fields (last gap, first About polaroid, closed). ES deliberately deferred.
