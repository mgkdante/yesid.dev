// Icon schema — runtime mirror of IconRecord from @repo/shared (slice-18h-ii Phase 5).
//
// Per Q5 pivot: iconify_id format validation uses a .transform() that WARNS
// and coerces to null on mismatch (non-throwing — degraded path renders
// placeholder; doesn't break the entire tech-stack page).
