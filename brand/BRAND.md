...
4. **Motion with intent.** Every animation serves one of three jobs: wayfinding, feedback, or emphasis. Nothing decorative. No entrance reveals. Full list in `foundations/motion.md`; doctrine lives at `docs/reference/CONSTITUTION.md § 8`.
...
8. **Do** cross-link to the authoritative rule (`docs/reference/CONSTITUTION.md`, `tokens.css`) rather than repeating rules here. Narrative here, rules there.
