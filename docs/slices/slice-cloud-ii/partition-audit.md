...
|---|------|---------|-------|------------------|--------------------|
| 1 | Task 2 | `iteration-protocol` | Iteration Protocol — 8-step task discipline | AGENTS § Iteration Protocol; WORKFLOW §8 Phase 5 (universal portions) | scaffold `AGENTS.md` + `docs/reference/WORKFLOW.md` |
| 2 | Task 2 | `session-progress-tracking` | Session progress tracking — 6 rules, STOP table, budget row | AGENTS § Session progress tracking; AGENTS § Session token budget; AGENTS § Session header format; WORKFLOW §18 per-STOP progress table | scaffold `AGENTS.md` + `docs/reference/WORKFLOW.md` |
| 3 | Task 3 | `8-phase-pipeline` | 8-phase pipeline diagram + per-phase protocols (Research → Brainstorm → Spec → Plan → Implementation → Verification → PR → Closing) | WORKFLOW §3 (pipeline); WORKFLOW §§4–11 (phase protocols) | scaffold `docs/reference/WORKFLOW.md` |
