...
**Referenced spec:** [./spec.md](./spec.md) (sibling file in this sub-slice bundle)

> **Note on paths in this plan:** Written pre-migration (before Task 3b). Historical task descriptions (Tasks 0, 0a, 1, 2, 3, 3a) reference old paths like `docs/devlog/2026-04-17-slice-17j-task-0.md` — these are accurate for WHAT WAS DONE at that time. Post-3b, the active artifacts live at `docs/slices/slice-17/slice-17j/{spec,plan,log,handoff}.md`. When reading forward-looking tasks (3b remainder, 3c–3f, 4–9), mentally map "devlog" → `log.md`, the old `docs/plans/2026-04-17-slice-17j-token-efficacy.md` → this file, and similar.
