...
| **18h** | Meta + route_seo (singleton + og_image) — first repo singleton; combined brand identity + SEO defaults per Q2 amendment; two-method API per Q9 (meta.site + meta.siteSeoDefaults sharing fetchSingletonRow memo); composedTitleStrategy flag preserves home em-dash format per P3 | ✅ closed 2026-04-27 | shipped (PR pending, ~17 commits) | [18h-meta-route-seo/](18h-meta-route-seo/) |
