...
- Don't reuse prod admin creds on dev. Dev admin is `admin@yesid.dev` (separate password). Prod admin is private-contact-07@example.invalid`.
...
| Title | What |
|---|---|
| `Directus admin - cms.yesid.dev` | Prod admin login (private-contact-07@example.invalid`) |
