...
**Files:** `src/lib/components/brand/StatusDot.svelte` (`ring` prop). See `<cloud>/yesid.dev/docs/learn/styling/outline-vs-ring-pulsing-dots.md` for the full explanation.
