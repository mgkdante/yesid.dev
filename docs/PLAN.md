...
| 08 | About + Contact pages (bento grid /about) | planned | 02, 03, 05 | 1 |
| 09 | SEO + metadata | planned | 06, 07, 08 | 1 |
| 10 | E2E test suite + performance + brand QA | planned | 06, 07, 08 | 1-2 |
| 11 | Repo cleanup for public release | planned | 09, 10 | 0.5 |
| 12 | Deploy to Vercel + DNS cutover | planned | 11 | 1 |
...
**Status:** planned
Replace the 3D ThreeJS wagon scene in the hero card with a Google Flow video that plays forward on scroll-down and rewinds on scroll-up. Removes Three.js/Threlte dependency from the hero. Keeps the contained card layout and art background. Video asset: `Train_to_decomposition` from Google Flow.

Slice spec: `docs/slices/slice-06f-video-hero.md`

### Slice 06e — Blog System (Markdown Content + Routes)
**Status:** planned
...
### Slice 10 — E2E Test Suite + Performance + Brand QA Pass
...
### Slice 11 — Repo Cleanup for Public Release
...
### Slice 12 — Deploy to Vercel + DNS Cutover
